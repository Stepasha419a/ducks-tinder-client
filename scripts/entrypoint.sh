...
REQUIRED_VARS="VAR_MODE PROXY_SERVER_NAME PROXY_CERT_PATH PROXY_KEY_PATH PROXY_USER_SERVICE PROXY_CHAT_SERVICE PROXY_FILE_SERVICE PROXY_AUTH_SERVICE PROXY_USER_SERVICE_URL PROXY_CHAT_SERVICE_URL PROXY_FILE_SERVICE_URL PROXY_AUTH_SERVICE_URL"
