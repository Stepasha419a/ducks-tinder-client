...
class AuthController {
    ...
    async registration(req: any, res: any, next: NextFunction) {
        try {
            ...
            const {email, name, nickname, password, age, sex, partnerSettings} = req.body
            const userData = await authService.registration(email, name, nickname, password, age, sex, partnerSettings)
