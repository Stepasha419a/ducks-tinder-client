        ...
        <div className={styles.groups}>
            <div className={styles.group}>
                ...
                <div className={styles.items}>
                    <div onClick={() => setSettingInput('Email', 'email')} className={`${styles.item} ${styles.item_pointer}`}>
                    ...
                    <div onClick={() => setSettingInput('Name', 'name')} className={`${styles.item} ${styles.item_pointer}`}>
                        <div className={styles.descr}>
                            <div className={styles.title}>
                                Name
                            </div>
                    ...
                    <div onClick={() => setSettingInput('Description', 'description')} className={`${styles.item} ${styles.item_pointer} ${errorFields.includes('description') ? styles.item_error : ''}`}>
                        <div className={styles.descr}>
                            <div className={styles.title}>
                                Description
                            </div>
                    ...
                    <div onClick={() => setSettingInput('Sex', 'sex')} className={`${styles.item} ${styles.item_pointer} ${errorFields.includes('sex') ? styles.item_error : ''}`}>
                        <div className={styles.descr}>
                            <div className={styles.title}>
                                Sex
                            </div>
            ...
            <div className={styles.group}>
                ...
                <div className={styles.items}>
                    <div onClick={() => setSettingInput('Interests', 'interests')} className={`${styles.item} ${styles.item_pointer} ${errorFields.includes('interests') ? styles.item_error : ''}`}>
                        <div className={styles.descr}>
                            <div className={styles.title}>
                                Interests
                            </div>
                    ...
                    <div onClick={() => setSettingInput('Place', 'place', 'partnerSettings')} className={`${styles.item} ${styles.item_pointer} ${errorFields.includes('place') ? styles.item_error : ''}`}>
                        <div className={styles.descr}>
                            <div className={styles.title}>
                                Place
                            </div>
                    ...
                    <div className={`${styles.item} ${errorFields.includes('distance') ? styles.item_error : ''}`}>
                        <div className={styles.descr}>
                            <div className={styles.title}>
                                Distance
                            </div>
                    ...
                    <div onClick={() => setSettingInput('Interested in', 'preferSex', 'partnerSettings')} className={`${styles.item} ${styles.item_pointer} ${errorFields.includes('preferSex') ? styles.item_error : ''}`}>
                        <div className={styles.descr}>
                            <div className={styles.title}>
                                Interested in
                            </div>
            ...
            <div className={styles.group}>
                ...
                <div className={styles.items}>
                    <div onClick={() => setSettingInput('Nickname', 'nickname')} className={`${styles.item} ${styles.item_pointer}`}>
                        <div className={styles.descr}>
                            <div className={styles.title}>
                                Nickname
                            </div>
            ...
            <div className={styles.group}>
                <div className={styles.items}>
                    <div onClick={() => dispatch(logoutThunk() as any)} className={`${styles.item} ${styles.item_button}`}>
                        <div className={styles.descr}>
